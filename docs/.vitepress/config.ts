...
const SLUG = 'agenzia-immobiliare';
const TITLE = 'Demo Agenzia Immobiliare — Federico Calò';

export default defineConfig({
  title: TITLE,
  description: 'Documentazione tecnica del template Angular 21 SSR per Agenzia Immobiliare.',
  base: `/federico-demo-${SLUG}/`,
  cleanUrls: true,
  lang: 'it-IT',

  themeConfig: {
    siteTitle: 'Demo Agenzia Immobiliare',
