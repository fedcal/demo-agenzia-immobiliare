...
URL: `https://agenzia-immobiliare.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `agenzia-immobiliare.demo.federicocalo.dev`
...
- Output directory: `dist/agenzia-immobiliare/browser`
...
URL: `https://fedcal.github.io/federico-demo-agenzia-immobiliare/`
...
- `base: /federico-demo-agenzia-immobiliare/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `agenzia-immobiliare-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   agenzia-immobiliare-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `agenzia-immobiliare-docs.federicocalo.dev`
...
```bash
npm run build
npm run serve:ssr:agenzia-immobiliare
# → http://localhost:4000
```
